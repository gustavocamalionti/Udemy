    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
            <div style="width:90%; margin-left:auto; margin-right:auto;">
                ...
                {{ $clientes -> firstItem() }} - Número do primeiro registro da página (não há relação com o id)
                {{ $clientes -> lastItem() }} - Número do último registro da página (não há relação com o id)
                -->
